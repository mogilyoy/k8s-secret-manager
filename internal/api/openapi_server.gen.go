...
// CreateSecretRequest Request body for creating a new k8s secret
...
// ListSecretsResponse List of secrets in the requested namespace
type ListSecretsResponse struct {
	// Items Array of secret objects
	Items     *[]SecretSummary `json:"items,omitempty"`
...
type SecretResponse struct {
	// CreationTimestamp Timestamp when the secret was created
	...
	// ResourceVersion K8s version string used for optimistic locking
	ResourceVersion *string `json:"resourceVersion,omitempty"`
	Type            *string `json:"type,omitempty"`
}

// SecretSummary Summary information about a secret
...
type UpdateSecretRequest struct {
	...
	// Type Optional type of the secret
	Type *string `json:"type,omitempty"`
}

// UserAuthRequest Request body to exchange Telegram initData for JWT.
type UserAuthRequest struct {
	// InitData Telegram Web App initData string
...
type AuthUserJSONRequestBody = UserAuthRequest
...
type AuthUser200JSONResponse AuthResponse
...
type AuthUser404JSONResponse struct{ NotFoundJSONResponse }

func (response AuthUser404JSONResponse) VisitAuthUserResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(404)
