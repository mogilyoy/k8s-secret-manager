...
```
CLI сохранит url и будет использовать его для дальнейших запросов. По умолчанию url хранит localhost:8080. При локальном запуске без ingress, см раздел "Доступ к API" в <a href="../README.md">README.md</a>  Чтобы изменить url, нужно выполнить команду заново
